  ...
  return (
          <li>
               ...
               <Cards className='flex flex-col gap-3 bg-gray-200 border border-gray-100 rounded-2xl relative'>
                          ...
                          <div>
                              <Link to={`/Detail/${data.id}`} className='flex flex-col gap-4'>
                          <img src={data.images[0]}  className='h-40 object-cover overflow-hidden rounded-md'/>
                          ...
                          <Button className='bg-black/50 text-white p-2 rounded-xl my-3 mx-5 '
